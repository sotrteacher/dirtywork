...
enum GameSignals {                        /* signals used in the game */
    ...
    UP_SIG,                    /* published by Player pressing a key */
    DOWN_SIG,                  /* published by Player pressing a key */
    ARM_SIG,                   /* published by Player pressing a key */
    ...
    //BOMB_SIG,        /* from Bomb4 to Tunnel to display Bomb's timeout */
